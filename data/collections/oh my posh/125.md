...
Display [Jujutsu](https://www.jj-vcs.dev/) information when in a Jujutsu repository.
...
−▢× mzvwutnw  +1 ~2 \_ohmyposh.dev−▢× mzvwutnw  +1 ~2 \_ohmyposh.dev
...
"ignore\_working\_copy":false,

"fetch\_ahead\_counter":true,
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/scm/jujutsu\#template-info "Direct link to template-info")
