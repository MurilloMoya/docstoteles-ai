[Skip to main content](https://ohmyposh.dev/docs/configuration/introduction#__docusaurus_skipToContent_fallback)
...
## Concept [​](https://ohmyposh.dev/docs/configuration/introduction\#concept "Direct link to Concept")
