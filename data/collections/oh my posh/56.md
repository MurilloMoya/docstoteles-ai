...
Display your [GitHub Copilot](https://github.com/features/copilot) usage statistics and quota information including premium interactions, inline completions, and chat usage.
This segment was inspired by [Elio Struyf's GitHub Copilot Usage Tauri application](https://github.com/estruyf/github-copilot-usage-tauri).
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/cli/copilot\#template-info "Direct link to template-info")
