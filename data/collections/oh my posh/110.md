...
Display the currently active [Python](https://www.python.org/) version and [virtualenv](https://virtualenv.pypa.io/).
Supports [conda](https://conda.org/), virtualenv and pyenv (if python points to pyenv shim).
...
−▢×  3.12.4 \_ohmyposh.dev−▢×  3.12.4 \_ohmyposh.dev
