...
Display [Subversion](https://subversion.apache.org/) information when in a subversion repository. Also works for subfolders. For maximum compatibility,
...
−▢× trunk r4821 ~2 \_ohmyposh.dev−▢× trunk r4821 ~2 \_ohmyposh.dev
