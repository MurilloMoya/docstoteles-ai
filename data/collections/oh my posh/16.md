...
### Restart Cycle [​](https://ohmyposh.dev/docs/configuration/block\#restart-cycle "Direct link to Restart Cycle")

When a [color cycle](https://ohmyposh.dev/docs/configuration/colors#cycle) is defined, its colors are shared across every block in the prompt and keep
...
- [Settings](https://ohmyposh.dev/docs/configuration/block#settings)
  ...
  - [Restart Cycle](https://ohmyposh.dev/docs/configuration/block#restart-cycle)
