...
This project uses [APM (Agent Package Manager)](https://github.com/microsoft/apm) to manage shared AI agent skills.
...
from the [agentic](https://github.com/JanDeDobbeleer/agentic) repository. Project-specific skills (segment-create and segment-docs)
