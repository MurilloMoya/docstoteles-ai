...
−▢×  trunk ~1 \_ohmyposh.dev−▢×  trunk ~1 \_ohmyposh.dev
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/scm/fossil\#template-info "Direct link to template-info")
