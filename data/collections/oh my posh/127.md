...
Display [Mercurial](https://www.mercurial-scm.org/) information when in a Mercurial repository. For maximum compatibility,
...
−▢×hg default  dev  tip  ~1\_ohmyposh.dev−▢×hg default  dev  tip  ~1\_ohmyposh.dev
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/scm/mercurial\#template-info "Direct link to template-info")
