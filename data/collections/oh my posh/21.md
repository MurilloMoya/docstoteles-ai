...
To set this configuration in combination with an Oh My Posh [executable](https://github.com/JanDeDobbeleer/oh-my-posh/releases/latest), use the `--config` flag to
...
| `terminal_features` | TerminalFeatures |  | map terminal features to the terminals supporting them. See [Terminal features](https://ohmyposh.dev/docs/configuration/general#terminal-features) |
...
| `streaming` | `int` |  | enable streaming mode with a timeout in milliseconds for pending segments. See [streaming](https://ohmyposh.dev/docs/configuration/streaming) |
...
### Terminal features [​](https://ohmyposh.dev/docs/configuration/general\#terminal-features "Direct link to Terminal features")
...
- [Settings](https://ohmyposh.dev/docs/configuration/general#settings)
  ...
  - [Terminal features](https://ohmyposh.dev/docs/configuration/general#terminal-features)
