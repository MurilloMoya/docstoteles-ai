...
−▢× ~/dev/oh-my-posh \_ohmyposh.dev−▢× ~/dev/oh-my-posh \_ohmyposh.dev
...
| `mapped_locations_regex_expand` | `boolean` | `false` | expand `$1`, `${name}`, etc. in a `re:` replacement value, see [below](https://ohmyposh.dev/docs/segments/system/path#expanding-capture-groups) |
...
### Expanding capture groups [​](https://ohmyposh.dev/docs/segments/system/path\#expanding-capture-groups "Direct link to Expanding capture groups")
...
- [Mapped Locations](https://ohmyposh.dev/docs/segments/system/path#mapped-locations)
  ...
  - [Expanding capture groups](https://ohmyposh.dev/docs/segments/system/path#expanding-capture-groups)
