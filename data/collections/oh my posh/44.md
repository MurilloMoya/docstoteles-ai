...
[Copilot CLI segment documentation](https://ohmyposh.dev/docs/segments/cli/copilot-cli).
...
Note this will still load Oh My Posh for [iTerm2](https://iterm2.com/) or any other modern day macOS terminal that supports ANSI characters.
...
## Package managers [​](https://ohmyposh.dev/docs/installation/prompt\#package-managers "Direct link to Package managers")
...
- [Package managers](https://ohmyposh.dev/docs/installation/prompt#package-managers)