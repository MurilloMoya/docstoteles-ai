...
## Gradients [​](https://ohmyposh.dev/docs/configuration/colors\#gradients "Direct link to Gradients")
...
Each stop can be a hex color or a [Palette reference](https://ohmyposh.dev/docs/configuration/colors#palette) (`p:name`), so gradients work with
...
### Auto-shade from a single color [​](https://ohmyposh.dev/docs/configuration/colors\#auto-shade-from-a-single-color "Direct link to Auto-shade from a single color")
...
color, see [Stops and segment width](https://ohmyposh.dev/docs/configuration/colors#stops-and-segment-width).
...
### Supported stops [​](https://ohmyposh.dev/docs/configuration/colors\#supported-stops "Direct link to Supported stops")
...
| [Palette reference](https://ohmyposh.dev/docs/configuration/colors#palette) to a hex color (`p:blue`) | yes |
...
A `background` or `foreground` keyword in a [color override](https://ohmyposh.dev/docs/configuration/colors#color-overrides) inside a gradient
...
output. Use [`dark-gradient`/`light-gradient`](https://ohmyposh.dev/docs/configuration/colors#auto-shade-from-a-single-color) for a one-color
gradient effect instead.

### Stops and segment width [​](https://ohmyposh.dev/docs/configuration/colors\#stops-and-segment-width "Direct link to Stops and segment width")
...
## Shades [​](https://ohmyposh.dev/docs/configuration/colors\#shades "Direct link to Shades")
...
[Palette reference](https://ohmyposh.dev/docs/configuration/colors#palette) to one (`darken(p:accent, 20)`). **ANSI color names** (`green`,
...
one of them, write its hex value into your [Palette](https://ohmyposh.dev/docs/configuration/colors#palette) once and shade the palette entry:
...
\
Alternatively, a palette value can be a [template](https://ohmyposh.dev/docs/configuration/templates) that resolves to any valid color value, including\
a _Palette reference_. The template is rendered every time the color is resolved, so it can use any of the\
[global template properties](https://ohmyposh.dev/docs/configuration/templates#global-properties) to switch colors based on context. For example, to use a\
...
\
You can now use _Palette references_ in any [Segment's](https://ohmyposh.dev/docs/configuration/segment)`foreground`, `foreground_templates`,\
...
\
Palette allows for recursive _Palette reference_ resolution, up to 3 levels deep. You can use a _Palette_\
_reference_ as a color value in Palette. This allows you to define named colors, and use references to those\
...
- [Gradients](https://ohmyposh.dev/docs/configuration/colors#gradients)\
  - [Auto-shade from a single color](https://ohmyposh.dev/docs/configuration/colors#auto-shade-from-a-single-color)\
  - [Supported stops](https://ohmyposh.dev/docs/configuration/colors#supported-stops)\
  - [Stops and segment width](https://ohmyposh.dev/docs/configuration/colors#stops-and-segment-width)\
- [Shades](https://ohmyposh.dev/docs/configuration/colors#shades)\
