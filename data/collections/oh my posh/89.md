...
event during Ramadan. Powered by the free [Aladhan Prayer Times API](https://aladhan.com/prayer-times-api). The segment
...
−▢×U0001F319 Roza 14 · Iftar in 2h 14m\_ohmyposh.dev−▢×U0001F319 Roza 14 · Iftar in 2h 14m\_ohmyposh.dev
...
| `method` | `int` | `3` | Prayer calculation method (0–23, 99). See [Aladhan methods](https://aladhan.com/calculation-methods) for details |
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/health/ramadan\#template-info "Direct link to template-info")
